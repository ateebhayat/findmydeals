...
import { useCustomerSignup } from '@/hooks/useAuth';
    ...
    signupMutation.mutate(
      {
        ...
        preferences: {
          categories: [], // You can add category selection if needed
          notifications: true,
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Create your free account and start saving money with exclusive deals from top brands.
              </p>
            </div>
          </div>
