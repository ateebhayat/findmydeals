      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mb-8">Thank you for contacting us. We'll get back to you within 24 hours.</p>
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary/10 to-secondary/10 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Have questions or need support? We're here to help. Reach out to us anytime.</p>
        </div>
      </section>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Click "Register Brand" and fill out our simple registration form. Verification typically takes 1-2 business days.</p>
                </div>
                <div>
                  <h4 className="font-medium mb-1">Is there a fee to list offers?</h4>
                  <p className="text-sm text-muted-foreground">Basic listing is free. We offer premium features for enhanced visibility and analytics.</p>
                </div>
                <div>
                  <h4 className="font-medium mb-1">How do I edit my offers?</h4>
                  <p className="text-sm text-muted-foreground">Log into your dashboard and navigate to the offers section to edit, activate, or deactivate your offers.</p>
                </div>
              </CardContent>
            </Card>
          </div>
